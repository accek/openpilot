...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"BelowSpeedPauseWithBlinker", PERSISTENT | BACKUP},
    ...
    {"HideBlinkerUi", PERSISTENT | BACKUP},
    ...
    {"PauseLateralSpeedWithBlinker", PERSISTENT | BACKUP},
    ...
    {"StockLaneLines", PERSISTENT | BACKUP},
