...
class Controls(ControlsExt, ModelStateBase):
  ...
  def state_control(self):
    ...
    return CC, CC_AC, lac_log, lac_log_ac

  def publish(self, CC, CC_AC, lac_log, lac_log_ac):
    CS = self.sm['carState']
  ...
  def run(self):
    ...
    try:
      ...
      while True:
        self.update()
        CC, CC_AC, lac_log, lac_log_ac = self.state_control()
        self.publish(CC, CC_AC, lac_log, lac_log_ac)
