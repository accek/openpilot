...
def get_car_params_callback(rc, pm, msgs, fingerprint):
  ...
  if fingerprint:
    ...
    _CI = get_car(can_recv, lambda _msgs: None, lambda obd: None, params.get_bool("AlphaLongitudinalEnabled"), False, Params().get_bool("PreferTorqueTune"), cached_params=cached_params)
